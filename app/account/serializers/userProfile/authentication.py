...
class ActivateUserProfileTokenSerializer(serializers.Serializer):
    """
    ...
    def validate(self,data):
        ...
        ensure_user_has_related_user_profile_object(user)
...
class AuthenticateUserProfileSerializer(serializers.Serializer):
    """" 
    Log In 
    """
...
class DeauthenticateUserProfileSerializer(serializers.Serializer):
    """ 
    Log Out
    """
    def save(self):
