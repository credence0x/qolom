...
from account.serializers.businessProfile import businessProfile
...
class AuthenticateBusinessProfileTests(APITestCase):
    def __init__(self, *args, **kwargs):
        super(AuthenticateBusinessProfileTests, self).__init__(*args, **kwargs)
    ...
    def setUpTestData(cls):
        ...
        cls.url = reverse('account:authenticate_business_profile')
    ...
    def test_authentication_of_inactive_user(self):
        ...
        # create test account
        create_account_url = reverse('account:create_business_profile')
        c = Client()
        data = self.create_data
        data["username"]="testingbusiness123"
        data["email"]="testingbusiness@gmail.com"
        data["name"]="Testing"
...
class DeauthenticateBusinessProfileTests(APITestCase):
    def __init__(self, *args, **kwargs):
        super(DeauthenticateBusinessProfileTests, self).__init__(*args, **kwargs)
    ...
    def setUpTestData(cls):
        ...
        user.is_active = True
        user.save()
        cls.authenticate_url = reverse('account:authenticate_business_profile')
        cls.url = reverse('account:deauthenticate_business_profile')
...
class ActivateBusinessProfileTokenTests(APITestCase):
    def __init__(self, *args, **kwargs):
        super(ActivateBusinessProfileTokenTests, self).__init__(*args, **kwargs)
    ...
    def test_activation_of_business_profile_account(self):
        """
        ...
        url = reverse('account:activate_business_profile') + query_params
